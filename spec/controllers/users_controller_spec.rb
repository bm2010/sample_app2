...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for singed-in-user" do
 ...
 describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New Name", :email => "user12@example.org", :password => "barbaz", :password_confirmation => "barbaz" }
      end
 ...
 describe "authentication of edit/update actions" do
   ...
   describe "for non-signed-in users" do
     ...
     it "should deny access to each 'edit'" do
        get :edit, :id => @user
        response.should redirect_to(signin_path)
        flash[:notice].should =~ /sign in/i
      end

      it "should deny access to each 'update'" do
